...
vin_fnc_debug_menu = { g_debug_menu };

vin_fnc_addDebugMenuItem = {
...
vin_fnc_initDebugMenu = {
	// [
	// 	"Vindicta",
	// 	"Open Menu",
	// 	["player", [], -100, "_this call vin_fnc_debug_menu"],
...
// 	[[], { gLocationMarkersOn = !gLocationMarkersOn; [gLocationMarkersOn, "o_Location_N"] call vin_fnc_toggleMarkers; } ] remoteExec ["call", 2];
// }] call vin_fnc_addDebugMenuItem;
// ["Map", "Toggle garrison markers", {
// 	[[], { gGarrisonMarkersOn = !gGarrisonMarkersOn; [gGarrisonMarkersOn, "o_AIGarrison_N"] call vin_fnc_toggleMarkers; } ] remoteExec ["call", 2];
// }] call vin_fnc_addDebugMenuItem;
