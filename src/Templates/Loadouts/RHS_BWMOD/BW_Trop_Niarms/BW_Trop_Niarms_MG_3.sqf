...
this addWeapon "BWA3_MG5_tan";
this addPrimaryWeaponItem "BWA3_acc_VarioRay_irlaser";
this addPrimaryWeaponItem "BWA3_optic_ZO4x30i_sand";
this addPrimaryWeaponItem "BWA3_120Rnd_762x51";

this addItemToUniform "FirstAidKit";
for "_i" from 1 to 2 do {this addItemToVest "BWA3_120Rnd_762x51";};
for "_i" from 1 to 2 do {this addItemToBackpack "BWA3_120Rnd_762x51_Tracer";};
