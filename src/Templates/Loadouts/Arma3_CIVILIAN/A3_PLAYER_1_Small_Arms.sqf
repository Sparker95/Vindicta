...
private _gunsAndAmmo = [
	// pistols
	["hgun_Pistol_heavy_01_F", 	"11Rnd_45ACP_Mag"],	1,
	["hgun_ACPC2_F", 			"9Rnd_45ACP_Mag"],	0.9,
	["hgun_P07_F", 				"16Rnd_9x21_Mag"],	0.8,
	["hgun_Rook40_F", 			"16Rnd_9x21_Mag"],	0.7
];
...
if(395180 in _ownedDLCs) then {
	...
	_gunsAndAmmo = _gunsAndAmmo + [
		// pistols
		["hgun_Pistol_01_F", 	"10Rnd_9x21_Mag"],	0.7,
		["hgun_P07_khk_F", 		"16Rnd_9x21_Mag"],	0.7
	];
};
...
(selectRandomWeighted _gunsAndAmmo) params ["_gun", "_ammo"];
