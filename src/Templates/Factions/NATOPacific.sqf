...
_veh set [T_VEH_IFV, ["B_T_APC_Wheeled_01_cannon_F", "B_T_APC_Tracked_01_CRV_F"]]; // = 6 – REQUIRED
_veh set [T_VEH_APC, ["B_T_APC_Tracked_01_rcws_F"]]; // = 7 – REQUIRED
_veh set [T_VEH_MBT, ["B_T_MBT_01_TUSK_F", "B_T_MBT_01_cannon_F", "B_T_AFV_Wheeled_01_cannon_F", "B_T_AFV_Wheeled_01_up_cannon_F"]]; // = 8 – REQUIRED
