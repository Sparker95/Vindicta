...
_array set [T_NAME, "tAT"];
_array set [T_DESCRIPTION, "Arrestatie Team. Dutch SWAT."];
_array set [T_DISPLAY_NAME, "NLD AT"];
...
_inf set [T_INF_default, ["NLD_AT_assault"]];					//Default infantry if nothing is found

_inf set [T_INF_SL, ["NLD_AT_TL"]];
_inf set [T_INF_TL, ["NLD_AT_assault", "NLD_AT_assault_p90"]];
_inf set [T_INF_officer, ["NLD_AT_assault", "NLD_AT_assault_p90", "NLD_AT_Breach", "NLD_AT_Medic"]];
/*
