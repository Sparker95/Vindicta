...
_veh set [T_VEH_IFV, ["O_APC_Tracked_02_cannon_F_1"]]; // = 6 – REQUIRED
_veh set [T_VEH_APC, ["O_APC_Wheeled_02_rcws_v2_F_1"]]; // = 7 – REQUIRED
_veh set [T_VEH_MBT, ["O_MBT_02_cannon_F_1", "O_MBT_02_cannon_F_2", "O_MBT_04_cannon_F_1", "O_MBT_04_cannon_F_2", "O_MBT_04_command_F_1", "O_MBT_04_command_F_2"]]; // = 8 – REQUIRED
