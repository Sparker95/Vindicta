...
_veh set [T_VEH_MRAP_HMG, ["gm_ge_army_fuchsa0_command", "gm_ge_army_fuchsa0_engineer"]]; // = 4 – REQUIRED
_veh set [T_VEH_MRAP_GMG, ["gm_ge_army_fuchsa0_reconnaissance"]]; // = 5 – REQUIRED
_veh set [T_VEH_IFV, ["gm_ge_army_marder1a1a", "gm_ge_army_marder1a2", "gm_ge_army_marder1a1a", "gm_ge_army_luchsa1", "gm_ge_army_luchsa2", "gm_ge_army_bpz2a0"]]; // = 6 – REQUIRED
