...
_veh set [T_VEH_heli_light, ["gm_ge_army_bo105m_vbh", "gm_ge_army_bo1051m_vbh", "gm_ge_army_bo1051m_vbh_swooper"]]; // = 20
...
_veh set [T_VEH_heli_attack, ["gm_ge_army_bo105p_pah1", "gm_ge_army_bo105p_pah1a"]]; // = 23
