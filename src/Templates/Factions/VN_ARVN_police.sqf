...
_inf set [T_INF_default, ["vn_i_men_army_22"]];	//Default infantry if nothing is found

_inf set [T_INF_SL, ["vn_i_men_army_22"]];
_inf set [T_INF_TL, ["vn_i_men_army_22"]];
_inf set [T_INF_officer, ["vn_i_men_army_22"]];

//==== Vehicles ====
_veh = []; _veh resize T_VEH_SIZE;
_veh set [T_VEH_DEFAULT, ["vn_i_wheeled_m151_01_mp"]];
_veh set [T_VEH_car_unarmed, ["vn_i_wheeled_m151_02_mp", "vn_i_wheeled_m151_01_mp"]];
