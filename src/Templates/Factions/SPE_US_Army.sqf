...
_array set [T_NAME, "tSPE_US_Army"];
_array set [T_DESCRIPTION, "World War 2 US Army made using content from Spearhead 1944 DLC."];
...
_veh set [T_VEH_car_unarmed, ["SPE_US_M3_Halftrack_Unarmed", "SPE_US_M3_Halftrack_Unarmed_Open"]];
//_veh set [T_VEH_car_armed, [""]];

//_veh set [T_VEH_MRAP_unarmed, [""]];
_veh set [T_VEH_MRAP_HMG, ["SPE_US_M3_Halftrack"]];
...
_veh set [T_VEH_personal, ["SPE_US_M3_Halftrack_Unarmed"]];

_veh set [T_VEH_truck_inf, ["SPE_US_M3_Halftrack_Unarmed", "SPE_US_M3_Halftrack_Unarmed_Open"]];
_veh set [T_VEH_truck_cargo, ["SPE_US_M3_Halftrack_Unarmed", "SPE_US_M3_Halftrack_Unarmed_Open"]];
_veh set [T_VEH_truck_ammo, ["SPE_US_M3_Halftrack_Ammo"]];
_veh set [T_VEH_truck_repair, ["SPE_US_M3_Halftrack_Repair"]];
_veh set [T_VEH_truck_medical , ["SPE_US_M3_Halftrack_Ambulance"]];
_veh set [T_VEH_truck_fuel, ["SPE_US_M3_Halftrack_Fuel"]];
