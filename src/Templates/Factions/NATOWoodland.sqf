...
_inf set [T_INF_rifleman, ["B_W_Soldier_F", 5, "B_W_Soldier_Lite_F", 3, "B_W_RadioOperator_F", 1]]; // = 5
_inf set [T_INF_marksman, ["B_W_soldier_M_F", 2, "B_W_Sharpshooter_F", 1]]; // = 6
_inf set [T_INF_sniper, ["B_W_ghillie_wdl_F"]]; // = 7
_inf set [T_INF_spotter, ["B_W_ghillie_spotter_wdl_F"]]; // = 8
...
_inf set [T_INF_HMG, ["B_W_HeavyGunner_F"]]; // = 15
...
_inf set [T_INF_pilot, ["B_W_Pilot_F"]]; // = 20
...
/* Recon unit classes */
_inf set [T_INF_recon_TL, ["B_W_Recon_TL_F"]]; // = 24
_inf set [T_INF_recon_rifleman, ["B_W_Recon_F"]]; // = 25
_inf set [T_INF_recon_medic, ["B_W_Recon_Medic_F"]]; // = 26
_inf set [T_INF_recon_exp, ["B_W_Recon_Exp_F"]]; // = 27
_inf set [T_INF_recon_LAT, ["B_W_Recon_LAT_F"]]; // = 28
_inf set [T_INF_recon_marksman, ["B_W_Recon_M_F", 2, "B_W_Recon_Sharpshooter_F", 1]]; // = 29
_inf set [T_INF_recon_JTAC, ["B_W_Recon_JTAC_F"]]; // = 30
/* Diver unit classes */
...
_veh set [T_VEH_DEFAULT, ["B_W_LSV_01_unarmed_F"]]; // = 0 Default if nothing found

_veh set [T_VEH_car_unarmed, ["B_W_LSV_01_unarmed_F"]]; // = 1 – REQUIRED
_veh set [T_VEH_car_armed, ["B_W_LSV_01_AT_F", "B_W_LSV_01_armed_F"]]; // = 2
_veh set [T_VEH_MRAP_unarmed, ["B_W_MRAP_01_F"]]; // = 3 – REQUIRED
_veh set [T_VEH_MRAP_HMG, ["B_W_MRAP_01_hmg_F"]]; // = 4 – REQUIRED
_veh set [T_VEH_MRAP_GMG, ["B_W_MRAP_01_gmg_F"]]; // = 5 – REQUIRED
_veh set [T_VEH_IFV, ["B_W_APC_Wheeled_01_cannon_F_1", "B_W_APC_Tracked_01_CRV_F_1"]]; // = 6 – REQUIRED
_veh set [T_VEH_APC, ["B_W_APC_Tracked_01_rcws_F_1"]]; // = 7 – REQUIRED
_veh set [T_VEH_MBT, ["B_W_MBT_01_cannon_F_1", "B_W_MBT_01_cannon_F_2", "B_W_MBT_01_TUSK_F_1", "B_W_MBT_01_TUSK_F_2", "B_W_AFV_Wheeled_01_cannon_F_1", "B_W_AFV_Wheeled_01_cannon_F_2",
 "B_W_AFV_Wheeled_01_up_cannon_F_1", "B_W_AFV_Wheeled_01_up_cannon_F_2"]]; // = 8 – REQUIRED
_veh set [T_VEH_MRLS, ["B_W_MBT_01_mlrs_F"]]; // = 9
_veh set [T_VEH_SPA, ["B_W_MBT_01_arty_F"]]; // = 10
_veh set [T_VEH_SPAA, ["B_W_APC_Tracked_01_AA_F"]]; // = 11
...
_veh set [T_VEH_heli_light, ["B_W_Heli_light_01_F"]]; // = 20
_veh set [T_VEH_heli_heavy, ["B_W_Heli_Transport_01_F"]]; // = 21
_veh set [T_VEH_heli_cargo, ["B_W_Heli_Transport_03_unarmed_F"]]; // = 22
_veh set [T_VEH_heli_attack, ["B_W_Heli_Attack_01_dynamicLoadout_F"]]; // = 23
_veh set [T_VEH_plane_attack, ["B_W_Plane_CAS_01_dynamicLoadout_F"]]; // = 24
_veh set [T_VEH_plane_fighter , ["B_W_Plane_Fighter_05_F"]]; // = 25
...
_veh set [T_VEH_truck_inf, ["B_W_Truck_01_transport_F", "B_W_Truck_01_covered_F"]]; // = 32 – REQUIRED
_veh set [T_VEH_truck_cargo, ["B_W_Truck_01_transport_F"]]; // = 33
_veh set [T_VEH_truck_ammo, ["B_W_Truck_01_ammo_F"]]; // = 34 – REQUIRED
_veh set [T_VEH_truck_repair, ["B_W_Truck_01_Repair_F"]]; // = 35
_veh set [T_VEH_truck_medical , ["B_W_Truck_01_medical_F"]]; // = 36
_veh set [T_VEH_truck_fuel, ["B_W_Truck_01_fuel_F"]]; // = 37
