...
_array set [T_NAME, "tSPE_Wehrmacht"];
_array set [T_DESCRIPTION, "World War 2 Wehrmacht made using content from Spearhead 1944 DLC."];
...
//_veh set [T_VEH_IFV, [""]];
//_veh set [T_VEH_APC, [""]];
_veh set [T_VEH_MBT, ["SPE_PzKpfwIII_J", "SPE_PzKpfwIII_L", "SPE_PzKpfwIII_M", "SPE_PzKpfwIII_N", "SPE_PzKpfwIV_G", "SPE_PzKpfwVI_H1", "SPE_Nashorn"]];
//_veh set [T_VEH_MRLS, [""]];
//_veh set [T_VEH_SPA, [""]];
_veh set [T_VEH_SPAA, ["SPE_OpelBlitz_Flak38"]];
...
_veh set [T_VEH_stat_AA, ["SPE_FlaK_38", "SPE_FlaK_36_AA"]];
