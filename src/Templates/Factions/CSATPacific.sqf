...
_veh set [T_VEH_IFV, ["O_T_APC_Tracked_02_cannon_ghex_F"]]; // = 6 – REQUIRED
_veh set [T_VEH_APC, ["O_T_APC_Wheeled_02_rcws_v2_ghex_F"]]; // = 7 – REQUIRED
_veh set [T_VEH_MBT, ["O_T_MBT_04_cannon_F", "O_T_MBT_04_command_F", "O_T_MBT_02_cannon_ghex_F"]]; // = 8 – REQUIRED
