...
_veh set [T_VEH_car_unarmed, ["gm_gc_army_uaz469_cargo"]]; // = 1 – REQUIRED
_veh set [T_VEH_car_armed, ["gm_gc_army_uaz469_dshkm"]]; // = 2
...
_veh set [T_VEH_stat_HMG_high, ["gm_gc_army_dshkm_aatripod"]]; // = 12 – REQUIRED
...
_veh set [T_VEH_truck_inf, ["gm_gc_army_ural4320_cargo", "gm_gc_army_ural375d_cargo"]]; // = 32 – REQUIRED
