...
_inf set [T_INF_SL, ["BW_Fleck_Niarms_SL","BW_Fleck_Niarms_SL_2"]];
_inf set [T_INF_TL, ["BW_Fleck_Niarms_TL"]];
_inf set [T_INF_officer, ["BW_Fleck_Niarms_officer"]];
_inf set [T_INF_GL, ["BW_Fleck_Niarms_grenadier","BW_Fleck_Niarms_grenadier2","BW_Fleck_Niarms_grenadier3"]];
_inf set [T_INF_rifleman, ["BW_Fleck_Niarms_rifleman"]];
_inf set [T_INF_marksman, ["BW_Fleck_Niarms_marksman"]];
_inf set [T_INF_sniper, ["BW_Fleck_Niarms_sniper","BW_Fleck_Niarms_sniper_2"]];
_inf set [T_INF_spotter, ["BW_Fleck_Niarms_spotter"]];
_inf set [T_INF_exp, ["BW_Fleck_Niarms_explosives"]];
_inf set [T_INF_ammo, ["BW_Fleck_Niarms_AT_2","BW_Fleck_Niarms_MG_2","BW_Fleck_Niarms_MG_4"]];
_inf set [T_INF_LAT, ["BW_Fleck_Niarms_AT"]];
_inf set [T_INF_AT, ["BW_Fleck_Niarms_AT","BW_Fleck_Niarms_AT_3","BW_Fleck_Niarms_AS","BW_Fleck_Niarms_AS_2"]];							//AS for Anti Structure
_inf set [T_INF_AA, ["BW_Fleck_Niarms_AA"]];
_inf set [T_INF_LMG, ["BW_Fleck_Niarms_LMG"]];
_inf set [T_INF_HMG, ["BW_Fleck_Niarms_MG","BW_Fleck_Niarms_MG_3"]];
_inf set [T_INF_medic, ["BW_Fleck_Niarms_medic"]];
_inf set [T_INF_engineer, ["BW_Fleck_Niarms_engineer"]];
_inf set [T_INF_crew, ["BW_Fleck_Niarms_crew"]];
_inf set [T_INF_crew_heli, ["BW_Fleck_Niarms_helicrew"]];
_inf set [T_INF_pilot, ["BW_Fleck_Niarms_pilot"]];
_inf set [T_INF_pilot_heli, ["BW_Fleck_Niarms_helipilot"]];
//_inf set [T_INF_survivor, [""]];
//_inf set [T_INF_unarmed, [""]];

// Recon
_inf set [T_INF_recon_TL, ["BW_Fleck_Niarms_recon_TL"]];
_inf set [T_INF_recon_rifleman, ["BW_Fleck_Niarms_Recon_Rifleman"]];
