...
vin_fnc_StartFreeingCivilian = {
	...
	[player, "Let me free you brother!",0.5] call vin_fnc_dialogue_createSentence;
};

// Callback for the end of the free civilian action
vin_fnc_CompleteFreeingCivilian = {
	...
	_this spawn {
		...
		[_target, "Thank you! One of those thugs dropped this, perhaps it is of interest to you."] call vin_fnc_dialogue_createSentence;
		sleep 6;
		// CALLSM("UnitIntel", "initObject", [_caller ARG 1]);

		[player, "(You take the papers handed to you)"] call vin_fnc_dialogue_createSentence;
		sleep 3;
		[player, "Thank you, you should get out of here now, more will be coming."] call vin_fnc_dialogue_createSentence;
		sleep 5;
		[_target, "I will, and you should go carefully aswell, they will be looking for you now!"] call vin_fnc_dialogue_createSentence;
		sleep 5;
...
vin_fnc_AddCivilianFreeAction = {
	[
		_this, "Free this civilian", "", "",
		"_this distance _target < 3",
		"_caller distance _target < 3",
		vin_fnc_StartFreeingCivilian, {}, vin_fnc_CompleteFreeingCivilian, {}, [], 8, 0, true, false
		...
		if(_deficit > 0) then {
			...
			for "_i" from 0 to (_deficit-1) do {
				...
				_civie spawn {
					...
					_this call vin_fnc_AddCivilianFreeAction;
				}
			};
		};
	ENDMETHOD;
