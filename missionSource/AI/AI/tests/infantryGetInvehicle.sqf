...
#ifndef _SQF_VM
"ai.rpt" ofstream_write "===== INFANTRY GET IN VEHICLE";
#endif
...
pr _unitGoalParameters = [ [TAG_MOVE_TARGET, "vehicleUnit"], [TAG_TARGET_VEHICLE_UNIT, "vehicleUnit"], [TAG_VEHICLE_ROLE, "Driver"]];
