...
_group set [T_GROUP_inf_assault_squad,	[[[T_INF, T_INF_SL], [T_INF, T_INF_LMG], [T_INF, T_INF_exp], [T_INF, T_INF_engineer], [T_INF, T_INF_TL], [T_INF, T_INF_LAT], [T_INF, T_INF_exp], [T_INF, T_INF_engineer]]]];
