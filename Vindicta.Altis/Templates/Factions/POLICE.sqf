...
_array set [T_DESCRIPTION, "Vanilla police. Apex DLC required."]; 	//Template display description
...
_api set [T_API_fnc_VEH_siren, {
	...
	if(typeOf _vehicle in ["B_GEN_Offroad_01_gen_F", "B_GEN_Van_02_transport_F"]) then {
