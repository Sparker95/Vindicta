...
_inf set [T_INF_rifleman, ["O_Soldier_F", 3, "O_Soldier_lite_F", 2]]; // = 5
_inf set [T_INF_marksman, ["O_soldier_M_F", 3, "O_Sharpshooter_F", 1]]; // = 6
...
_inf set [T_INF_AT, ["O_Soldier_HAT_F", 5, "O_Soldier_AT_F", 1]]; // = 12
...
_inf set [T_INF_recon_marksman, ["O_recon_M_F", 3, "O_Pathfinder_F", 1]]; // = 29
...
_veh set [T_VEH_heli_attack, ["O_Heli_Light_02_dynamicLoadout_F", 2, "O_Heli_Attack_02_dynamicLoadout_F", 1]]; // = 23
