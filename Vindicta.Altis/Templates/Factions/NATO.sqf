...
_inf set [T_INF_rifleman, ["B_Soldier_F", 3, "B_Soldier_lite_F", 2]]; // = 5
_inf set [T_INF_marksman, ["B_soldier_M_F", 3, "B_Sharpshooter_F", 1]]; // = 6
...
_inf set [T_INF_recon_marksman, ["B_recon_M_F", 3, "B_Recon_Sharpshooter_F", 1]]; // = 29
