...
_inf set [T_INF_SL, ["BW_Trop_SL","BW_Trop_SL_2"]];
_inf set [T_INF_TL, ["BW_Trop_TL"]];
_inf set [T_INF_officer, ["BW_Trop_officer"]];
_inf set [T_INF_GL, ["BW_Trop_grenadier","BW_Trop_grenadier2","BW_Trop_grenadier3"]];
_inf set [T_INF_rifleman, ["BW_Trop_rifleman"]];
_inf set [T_INF_marksman, ["BW_Trop_marksman"]];
_inf set [T_INF_sniper, ["BW_Trop_sniper","BW_Trop_sniper_2"]];
_inf set [T_INF_spotter, ["BW_Trop_spotter"]];
_inf set [T_INF_exp, ["BW_Trop_explosives"]];
_inf set [T_INF_ammo, ["BW_Trop_AT_2","BW_Trop_MG_2","BW_Trop_MG_4"]];
_inf set [T_INF_LAT, ["BW_Trop_AT"]];
_inf set [T_INF_AT, ["BW_Trop_AT","BW_Trop_AT_3","BW_Trop_AS","BW_Trop_AS_2"]];							//AS for Anti Structure
_inf set [T_INF_AA, ["BW_Trop_AA"]];
_inf set [T_INF_LMG, ["BW_Trop_LMG"]];
_inf set [T_INF_HMG, ["BW_Trop_MG","BW_Trop_MG_3"]];
_inf set [T_INF_medic, ["BW_Trop_medic"]];
_inf set [T_INF_engineer, ["BW_Trop_engineer"]];
_inf set [T_INF_crew, ["BW_Trop_crew"]];
_inf set [T_INF_crew_heli, ["BW_Trop_helicrew"]];
_inf set [T_INF_pilot, ["BW_Trop_pilot"]];
_inf set [T_INF_pilot_heli, ["BW_Trop_helipilot"]];
//_inf set [T_INF_survivor, [""]];
//_inf set [T_INF_unarmed, [""]];

// Recon
_inf set [T_INF_recon_TL, ["BW_Trop_recon_TL"]];
_inf set [T_INF_recon_rifleman, ["BW_Trop_Recon_Rifleman"]];
_inf set [T_INF_recon_medic, ["BW_Trop_recon_medic"]];
_inf set [T_INF_recon_exp, ["BW_Trop_recon_explosives"]];
_inf set [T_INF_recon_LAT, ["BW_Trop_recon_LAT"]];
//_inf set [T_INF_recon_LMG, ["BW_Trop_Recon_LMG"]];
_inf set [T_INF_recon_marksman, ["BW_Trop_recon_sniper","BW_Trop_Recon_sniper_2"]];
_inf set [T_INF_recon_JTAC, ["BW_Trop_recon_JTAC"]];
...
_veh set [T_VEH_MRAP_HMG, ["rhsusf_CGRCAT1A2_M2_usmc_d", "rhsusf_m1240a1_m2_usmc_d", "rhsusf_m1240a1_m240_usmc_d","rhsusf_M1220_M2_usarmy_d","rhsusf_M1220_MK19_usarmy_d"]];
_veh set [T_VEH_MRAP_GMG, ["rhsusf_m1240a1_mk19_usmc_d", "rhsusf_CGRCAT1A2_Mk19_usmc_d", "rhsusf_M1232_MC_MK19_usmc_d", "rhsusf_m1025_d_s_Mk19"]];
