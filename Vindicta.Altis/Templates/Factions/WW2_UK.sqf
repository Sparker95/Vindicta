...
_array set [T_DESCRIPTION, "WW2 UK units. 1939-1945."]; 	//Template display description
...
_inf set [T_INF_rifleman, ["WW2_UK_rifleman", 3, "WW2_UK_rifleman_2", 1, "WW2_UK_rifleman_3", 1]];
...
_inf set [T_INF_AT, ["WW2_UK_AT", 3, "WW2_UK_AT_2", 1]];
