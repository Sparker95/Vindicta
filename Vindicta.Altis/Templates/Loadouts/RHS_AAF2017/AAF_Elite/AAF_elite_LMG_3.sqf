...
for "_i" from 1 to 2 do {this addItemToBackpack "rhsgref_50Rnd_792x57_SmK_alltracers_drum";};
for "_i" from 1 to 2 do {this addItemToBackpack "rhsgref_50Rnd_792x57_SmK_drum";};
