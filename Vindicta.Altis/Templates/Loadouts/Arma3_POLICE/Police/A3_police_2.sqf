...
/*Helmet*/
_RandomHeadgear = selectRandom ["H_Cap_police", "H_MilCap_blue", "H_Cap_police", "H_MilCap_blue", "H_Cap_police", "H_MilCap_blue", "H_Cap_police", "H_MilCap_blue", "H_PASGT_basic_blue_F", "H_PASGT_basic_black_F"];
