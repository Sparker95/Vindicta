...
//	==== Backpack ====
this addBackpack selectRandom "UK3CB_BAF_B_Bergen_MTP_Rifleman_L_D";

// ==== BackPack Contents ====
for "_i" from 1 to 2 do {this addItemToBackpack "UK3CB_BAF_762_200Rnd_T";};
this addItemToBackpack "UK3CB_BAF_762_100Rnd_T";
