...
pr0_fnc_StartFreeingCivilian = {
	...
	[player, "Let me free you brother!",0.5] call pr0_fnc_dialogue_createSentence;
};
...
pr0_fnc_CompleteFreeingCivilian = {
	...
	_this spawn {
		...
		[player, "There you go, tell your friends of what transpired here today!"] call pr0_fnc_dialogue_createSentence;
		sleep 5;

		// Intel reward for player
		[_target, "Thank you! One of those thugs dropped this, perhaps it is of interest to you."] call pr0_fnc_dialogue_createSentence;
		sleep 6;
		// CALLSM("UnitIntel", "initObject", [_caller ARG 1]);

		[player, "(You take the papers handed to you)"] call pr0_fnc_dialogue_createSentence;
		sleep 3;
		[player, "Thank you, you should get out of here now, more will be coming."] call pr0_fnc_dialogue_createSentence;
		sleep 5;
		[_target, "I will, and you should go carefully aswell, they will be looking for you now!"] call pr0_fnc_dialogue_createSentence;
		sleep 5;
