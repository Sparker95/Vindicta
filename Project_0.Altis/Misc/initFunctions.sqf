...
misc_fnc_getVehiclesInBuilding = compile preprocessFileLineNumbers "Misc\fn_getVersion.sqf";
misc_fnc_getVehiclesInBuilding = compile preprocessFileLineNumbers "Misc\fn_getSaveVersion.sqf";