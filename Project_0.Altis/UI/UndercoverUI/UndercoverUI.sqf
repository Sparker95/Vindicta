...
g_UM_Hints = [
	...
	HK_SUSPGEAR, "SUSPICIOUS EQUIPMENT!",
	HK_MILVEH, "THIS IS A MILITARY VEHICLE!",
	HK_SUSPGEARVEH, "DO NOT GET TOO CLOSE WITH THIS EQUIPMENT!",
	HK_CLOSINGIN, "THEY ARE GOING TO SPOT YOU!",
	HK_SUSPBEHAVIOR, "SUSPICIOUS BEHAVIOUR!",
	HK_OFFROAD, "OFF-ROAD!",
	HK_ALLOWEDAREA, "THIS AREA IS BEING WATCHED!"
];
