...
fnc_UM_addActionUntieLocal = compile preprocessfilelinenumbers "Undercover\fn_UM_addActionUntieLocal.sqf";
fnc_UM_addActionUntieMP = compile preprocessfilelinenumbers "Undercover\fn_UM_addActionUntieLocal.sqf";
