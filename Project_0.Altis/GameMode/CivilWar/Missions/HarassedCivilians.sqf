...
CLASS("HarassedCiviliansAmbientMission", "AmbientMission")
	...
	METHOD("new") {
		...
		private _civGroups = [];
		private _civCount = 1 + (5 * ln(0.01 * _radius + 1) min 10);
		OOP_INFO_MSG("Spawning %1 civilians in %2 to be harassed", [_civCount ARG _city]);
				...
				[
					...
					"_caller distance _target < 3",
					{
						...
						_this spawn {
							...
							_target allowFleeing 1; // Run away!!!
