call {
    ...
    if ("MessageReceiver" != "") then {
        if (!(["MessageReceiver", "c:\Users\billw\Documents\Arma 3\mpmissions\Project_0\Project_0.Altis\OOP_Light\OOP_Light.h", 513] call OOP_assert_class)) then {
            ...
            diag_log _o_str;;
            ade_dumpCallstack;
            throw ["c:\Users\billw\Documents\Arma 3\mpmissions\Project_0\Project_0.Altis\OOP_Light\OOP_Light.h", 768, _msg];
        };
