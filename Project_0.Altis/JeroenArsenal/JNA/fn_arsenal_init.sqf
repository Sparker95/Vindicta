...
if(hasInterface)then{
    ...
    _id = _object addaction [
		(format ["<img image='%1' size='1.3' color='#ffffff'/>", STR_ACTION_ICON_ARSENAL] + format["<t size='1.2'>   %1</t>", STR_ACTION_TEXT_ARSENAL]),
        {
    ...
    _id = _object addaction [
		(format ["<img image='%1' size='1.3' color='#ffffff'/>", STR_ACTION_ICON_ARSENAL_CONTAINER] + format["<t size='1.2'>   %1</t>", STR_ACTION_TEXT_ARSENAL_CONTAINER]),
        {
			pr _object = _this select 0;
    ...
    _id = _object addaction [
		(format ["<img image='%1' size='1.3' color='#ffffff'/>", STR_ACTION_ICON_ARSENAL_UNLOAD] + format["<t size='1.2'>   %1</t>", STR_ACTION_TEXT_ARSENAL_UNLOAD]),
        {
			pr _object = _this select 0;
