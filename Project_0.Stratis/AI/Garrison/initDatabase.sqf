...
["GoalGarrisonMoveCargo", _s,			[[WSP_GAR_CARGO_POSITION, TAG_G_CARGO_POS, true],
...
["ActionGarrisonMoveMounted", _s,		[	[WSP_GAR_POSITION,	TAG_A_POS,	true],
											[WSP_GAR_VEHICLES_POSITION,	TAG_A_POS,	true]]] call AI_misc_fnc_setActionEffects; // Position is defined in parameter 0 of the action
...
["ActionGarrisonMoveMountedCargo", _s,		[	[WSP_GAR_POSITION,	TAG_A_POS,	true], 
												[WSP_GAR_CARGO_POSITION,	TAG_A_POS,	true],
												[WSP_GAR_VEHICLES_POSITION,	TAG_A_POS,	true]]] 		call AI_misc_fnc_setActionEffects; // Position is defined in parameter 0 of the action
...
["ActionGarrisonMoveDismounted", _s,	[	[WSP_GAR_POSITION,	TAG_A_POS,	true]]]			call AI_misc_fnc_setActionEffects; // Position is defined in parameter 0 of the action
...
["ActionGarrisonLoadCargo", 			[TAG_G_CARGO]] call AI_misc_fnc_setActionParametersFromGoal;
